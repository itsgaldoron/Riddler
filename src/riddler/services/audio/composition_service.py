...
from riddler.config.exceptions import AudioCompositionError
from riddler.services.audio.base import AudioCompositionServiceBase
...
class AudioCompositionService(AudioCompositionServiceBase):
    """Service for composing audio for riddle videos."""
    ...
    def __init__(self, config: Dict = None, logger: logging.Logger = None):
        ...
        self.countdown_sound = get_resource_path("assets", "audio", "countdown.mp3")
        self.reveal_sound = get_resource_path("assets", "audio", "reveal.mp3")
